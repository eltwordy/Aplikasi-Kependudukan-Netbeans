...
public class form_entry_penduduk1 extends javax.swing.JDialog {
    DefaultTableModel tabel = new DefaultTableModel();
    DefaultTableModel tabel2 = new DefaultTableModel();

    public form_entry_penduduk1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   //     tampil_tb_datapenduduk();
        disableForm();
        getTable();
        lebarKolom();
        loadData();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("KELOLA DATA PENDUDUK");
    ...
    private void jTable1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MousePressed
        //    if(evt.getClickCount()==1){
            //        try {
                ...
                //            Logger.getLogger(form_entry_datapenduduk.class.getName()).log(Level.SEVERE, null, ex);
                //        }
            //    }
    ...
    private void jButtonsimpanBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonsimpanBActionPerformed
        if (jnokk.getText().equals("") || jnik.getText().equals("") || jnamalengkap.getText().equals("") || cmbjk.getSelectedItem().equals("") || cmbstatusmerital.getSelectedItem().equals("")|| jtempatlahir.getText().equals("")|| jDateChoosertanggallahir.getDate().equals("") || jumur.getText().equals("") || jpendidikanterakhir.getText().equals("")|| jpekerjaan.getText().equals("")|| cmbstatusdalamkeluarga.getSelectedItem().equals("")||  cmbstatuspenduduk.getSelectedItem().equals("") ) {
...
//        lebar_kolom.setPreferredWidth(30);
        lebar_kolom = jTable1.getColumnModel().getColumn(11); //statuspenduduk
...
//            java.sql.Connection line_konek = new koneksi_2().getConnection();
          ...
          //      getO[11] = line_result.getString("rt");
                getO[11] = line_result.getString("statuspenduduk");
                tabel.addRow(getO);
            }
            line_result.close();
            line_statemen.close();
     ...
     //   String rt = cmbrt.getSelectedItem().toString();
        ...
        try {
            ...
            if(sql_statement.executeUpdate(query_inputa)==1){
                 String query_input = "insert into datapenduduk values ('" + nokk + "','" + nik + "','" + namalengkap + "','" + jk + "','" + statusmerital + "','" + tempatlahir + "','" + tanggallahir+ "','" + umur + "','" + pendidikanterakhir + "','" + pekerjaan+ "','" + statusdalamkeluarga + "','" + statuspenduduk + "')";
    ...
    private void ubah_data() {
     ...
     //   String rt = cmbrt.getSelectedItem().toString();
        String statuspenduduk = cmbstatuspenduduk.getSelectedItem().toString();
            ...
            Connection sql_query_koneksi = (Connection) si_pergudangan.koneksi.konekDB.getDB();
            String sql_query_update = "update datapenduduk set namalengkap='" + namalengkap + "', jk='" + jk + "',statusmerital='" + statusmerital + "', tempatlahir='" + tempatlahir + "',tanggallahir ='" + tanggallahir+ "',umur ='" + umur+ "',pendidikanterakhir ='" + pendidikanterakhir+ "',pekerjaan ='" + pekerjaan+ "',statusdalamkeluarga ='" + statusdalamkeluarga+ "', statuspenduduk ='" + statuspenduduk+ "' where nik='" + nik + "'";
    ...
    private void hapus() {
     ...
     //   String getRt = jTable1.getValueAt(jTable1.getSelectedRow(), 11).toString();
        String getStatuspenduduk = jTable1.getValueAt(jTable1.getSelectedRow(), 11).toString();
...
//    private DefaultTableModel tabmodecaripenduduk;
//    public void pencarian_penduduk(){
//        String cari = txt_cari_penduduk.getText();
//        //Object[] Baris={"No.KK","NIK","Nama Lengkap","JK","Status Merital","Tempat Lahir","Tanggal Lahir","Umur","Pendidikan Terakhir","Pekerjaan","Status Keluarga"};
//        Object[] Baris={"Nama Lengkap","JK","Status Merital","Tempat Lahir","Tanggal Lahir","Umur","Pendidikan Terakhir","Pekerjaan","Status Keluarga"};
//        tabmodecaripenduduk = new DefaultTableModel(null, Baris);
//        jTable1.setModel(tabmodecaripenduduk);
//
//        java.sql.Connection koneksi = new koneksi().getConnection();
//        try{
//          String sql="Select * from datapenduduk where   namalengkap like '%"+cari+"%' or jk like '%"+cari+"%' or statusmerital like '%"+cari+"%' or tempatlahir like '%"+cari+"%' or tanggallahir like '%"+cari+"%' or umur like '%"+cari+"% or pendidikanterakhir like '%"+cari+"%' or pekerjaan like '%"+cari+"%' or statusdalamkeluarga like '%"+cari+"%' order by nokk asc";
//       //     String sql="Select * from datapenduduk where nokk like '%"+cari+"%' or nik like '%"+cari+"%' or namalengkap like '%"+cari+"%' or jk like '%"+cari+"%' or ttl like '%"+cari+"%' or alamat like '%"+cari+"%' or statuskeluarga like '%"+cari+"%' or namaibu like '%"+cari+"%' or rt like '%"+cari+"%' order by nokk asc";
...
//                
//               String[] dataField = { namalengkap, jk, statusmerital, tempatlahir, tanggallahir, umur, pendidikanterakhir, pekerjaan, statusdalamkeluarga};
//                tabmodecaripenduduk.addRow(dataField);
//            }
//        } catch(Exception ex){
//        }
...
//    private void tampil_tb_datapenduduk1(){
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_entry_penduduk1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                form_entry_penduduk1 dialog = new form_entry_penduduk1(new javax.swing.JFrame(), true);
