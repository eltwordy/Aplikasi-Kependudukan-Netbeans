...
public class form_entry_penduduk extends javax.swing.JDialog {
    DefaultTableModel tabel = new DefaultTableModel();
    DefaultTableModel tabel2 = new DefaultTableModel();

    public form_entry_penduduk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_entry_penduduk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                form_entry_penduduk dialog = new form_entry_penduduk(new javax.swing.JFrame(), true);
